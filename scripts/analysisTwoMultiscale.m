...
workspace_path = '../../../';
output_dir = '../outputImgNet/';
checkpoint_dir = '../outputImgNet/Checkpoints/';
...
if analyze_Recon_flag
   ...
   for i_recon = 1:numRecons
      ...
      for i_frame = 1:frameSkip:numFrames
         ...
         %Concat images
         outImg = [scaled_inputImage scaled_inputImage scaled_inputImage; scaled_reconObj scaled_reconFace scaled_reconImage; scaled_v1Image scaled_ffav1Image scaled_mixv1; scaled_p1Image scaled_ffap1Image scaled_mixp1; scaled_p2Image scaled_ffap2Image scaled_mixp2];
         %Write image
