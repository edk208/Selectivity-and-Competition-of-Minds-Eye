...
local numImages           = 735; --Total number of images in dataset
...
local inputPath           = "../pathtoimages.txt";
...
--------------------------------------------------------------------
   ...
   V1ToInputError = {
      ...
      initWeightsFile                     = "../Object/V1ToInputError_W.pvp";
      triggerLayerName                    = "Input";
      triggerOffset                       = 0;
   ...
   FFAV1ToInputError = {
      ...
      initializeFromCheckpointFlag        = true;
      weightInitType                      = "FileWeight";
      initWeightsFile                     = "../Face/V1ToInputError_W.pvp";
      triggerLayerName                    = "Input";
      triggerOffset                       = 0;
      immediateWeightUpdate               = true;
      updateGSynFromPostPerspective       = false; -- Should be false from V1 (sparse layer) to Error (not sparse). Otherwise every input from pre will be calculated (Instead of only active ones)
   ...
   P1ToV1Error = {
      ...
      initializeFromCheckpointFlag        = true;
      weightInitType                      = "FileWeight";
      initWeightsFile                     = "../Object/P1ToV1Error_W.pvp";
      triggerLayerName                    = "Input";
      triggerOffset                       = 0;
      immediateWeightUpdate               = true;
      updateGSynFromPostPerspective       = false; -- Should be false from V1 (sparse layer) to Error (not sparse). Otherwise every input from pre will be calculated (Instead of only active ones)
   ...
   FFAP1ToV1Error = {
      ...
      initializeFromCheckpointFlag        = true;
      weightInitType                      = "FileWeight";
      initWeightsFile                     = "../Face/P1ToV1Error_W.pvp";
      triggerLayerName                    = "Input";
      triggerOffset                       = 0;
      immediateWeightUpdate               = true;
      updateGSynFromPostPerspective       = false; -- Should be false from V1 (sparse layer) to Error (not sparse). Otherwise every input from pre will be calculated (Instead of only active ones)
 ...
 FFAP1P2ReconToV1P2Recon = {
   ...
   P2ToP1Error = {
      ...
      initializeFromCheckpointFlag        = true;
      weightInitType                      = "FileWeight";
      initWeightsFile                     = "../Object/P2ToP1Error_W.pvp";
      triggerLayerName                    = "Input";
      triggerOffset                       = 0;
      immediateWeightUpdate               = true;
      updateGSynFromPostPerspective       = false; -- Should be false from V1 (sparse layer) to Error (not sparse). Otherwise every input from pre will be calculated (Instead of only active ones)
   ...
   FFAP2ToP1Error = {
      ...
      initializeFromCheckpointFlag        = true;
      weightInitType                      = "FileWeight";
      initWeightsFile                     = "../Face/P2ToP1Error_W.pvp";
      triggerLayerName                    = "Input";
      triggerOffset                       = 0;
      immediateWeightUpdate               = true;
      updateGSynFromPostPerspective       = false; -- Should be false from V1 (sparse layer) to Error (not sparse). Otherwise every input from pre will be calculated (Instead of only active ones)
...
--os.execute("../../../python/draw -p -a " .. "./FFAImg.params &");
