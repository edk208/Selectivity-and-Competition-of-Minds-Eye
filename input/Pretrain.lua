...
local patchSize           = 8;
local stride              = 4
local displayPeriod       = 200;   --Number of timesteps to find sparse approximation
...
local file = io.open("./Pretrain.params", "w");
io.output(file);
pv.printConsole(pvParameters)
io.close(file);
-- The & makes it run without blocking execution
--os.execute("../../../python/draw -p -a " .. "./Pretrain.params &");
os.execute("mpirun -np 1 ../../../build/tests/BasicSystemTest/Release/BasicSystemTest -p Pretrain.params -t 4");
